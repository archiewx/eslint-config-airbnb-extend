...
export default class CustomerCreateOrEdit extends PureComponent {
  ...
  componentDidMount() {
    (async () => {
      this.props.dispatch({ type: 'customerCreateOrEdit/setState',
        payload: {
          showData: {},
        } });
    ...
    validateFields((err, value) => {
      if (!err) {
        ...
        if (this.props.customerCreateOrEdit.showData.id) {
          this.props.dispatch({ type: 'customerCreateOrEdit/editSingle',
            payload: {
          ...
          this.props.dispatch({ type: 'customerCreateOrEdit/createSingle',
            payload: {
              serverData: this.props.customerCreateOrEdit.serverData,
              imageFile: this.props.customerCreateOrEdit.imageFile,
            } }).then(() => {
