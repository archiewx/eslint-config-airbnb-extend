...
export default class SupplierDetail extends PureComponent {
  ...
  handleChangeSupplierStatus = (id, status) => {
    this.props.dispatch({ type: 'supplierDetail/changeSupplierStatus',
      payload: {
        id,
        freeze: status == 1 ? 0 : 1,
      } });
  ...
  handleGoodsHistorySort = (pagination, filter, sorter) => {
    ...
    this.props.dispatch({ type: 'supplierDetail/getGoodsHistory',
      payload: {
  ...
  handleGoodsFormSubmit = () => {
    ...
    setTimeout(() => {
      form.validateFields((err, value) => {
        if (!err) {
          this.props.dispatch({ type: 'supplierDetail/setFilterGoodsServerData',
            payload: {
              ...value,
  ...
  handlePaymentHistorySort = (pagination, filter, sorter) => {
    ...
    this.props.dispatch({ type: 'supplierDetail/getPaymentHistory',
      payload: {
  ...
  handlePaymentFormSubmit = () => {
    ...
    setTimeout(() => {
      form.validateFields((err, value) => {
        if (!err) {
          this.props.dispatch({ type: 'supplierDetail/setFilterPurchaseServerData',
            payload: {
              ...value,
  ...
  handlePurchaseorderSort = (pagination, filter, sorter) => {
    ...
    this.props.dispatch({ type: 'supplierDetail/getPurchaseorder',
      payload: {
        ...purchaseorderSort,
        id: this.props.supplierDetail.currentId.id,
      } });
  ...
  handleStatementSort = (pagination, filter, sorter) => {
    ...
    this.props.dispatch({ type: 'supplierDetail/getStatement',
      payload: {
        ...statementSort,
        id: this.props.supplierDetail.currentId.id,
      } });
