...
export default class Inventory extends PureComponent {
  ...
  render() {
    ...
    const columns = [{
      ...
      render:(text,record) => <Switch checkedChildren="开" unCheckedChildren="关" checked={record.user_name ? true : false} onClick={this.handleSwitchCurrentWarehouse.bind(null,record)} />
    },{
      title:'操作',
      dataIndex:'operation',
      width:172,
